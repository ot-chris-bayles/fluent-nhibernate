...
namespace FluentNHibernate.Mapping
{
    ...
    public class AnyPart<T> : IAnyMappingProvider
    {
        ...
        public AnyPart(Type entity, Member member)
        {
            this.entity = entity;
            this.member = member;
            access = new AccessStrategyBuilder<AnyPart<T>>(this, value => attributes.Set(x => x.Access, Layer.UserSupplied, value));
            cascade = new CascadeExpression<AnyPart<T>>(this, value => attributes.Set(x => x.Cascade, Layer.UserSupplied, value));
        ...
        {
            attributes.Set(x => x.IdType, Layer.UserSupplied, type.AssemblyQualifiedName);
            idTypeSet = true;
            return this;
        }
        ...
        {
            attributes.Set(x => x.MetaType, Layer.UserSupplied, new TypeReference(typeof(TMetaType)));
            return this;
        }
        ...
        {
            attributes.Set(x => x.MetaType, Layer.UserSupplied, new TypeReference(metaType));
            return this;
        }
