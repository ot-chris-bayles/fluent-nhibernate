...
namespace FluentNHibernate.Mapping
{
    public class VersionPart : IVersionMappingProvider
    {
        ...
        public VersionPart(Type entity, Member member)
        {
            this.entity = entity;
            this.member = member;
            access = new AccessStrategyBuilder<VersionPart>(this, value => attributes.Set(x => x.Access, Layer.UserSupplied, value));
            generated = new VersionGeneratedBuilder<VersionPart>(this, value => attributes.Set(x => x.Generated, Layer.UserSupplied, value));
        ...
        VersionMapping IVersionMappingProvider.GetVersionMapping()
        {
            ...
            var defaultColumnMapping = new ColumnMapping(columnAttributes.CloneInner());
