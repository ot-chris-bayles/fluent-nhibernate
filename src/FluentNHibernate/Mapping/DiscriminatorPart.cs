...
namespace FluentNHibernate.Mapping
{
    public class DiscriminatorPart : IDiscriminatorMappingProvider
    {
        ...
        {
            attributes.Set(x => x.Force, Layer.UserSupplied, nextBool);
            nextBool = true;
            return this;
        }
        ...
        {
            attributes.Set(x => x.Formula, Layer.UserSupplied, sql);
            return this;
        }
        ...
        public DiscriminatorPart SqlType(string type) {
            columnAttributes.Set(x => x.SqlType, Layer.UserSupplied, type);
            return this;
        }
